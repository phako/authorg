...
#define AUTHORG_TOOLS_PAGE(obj) (GTK_CHECK_CAST ((obj), AUTHORG_TYPE_TOOLS_PAGE, AuthorgToolsPage))
#define AUTHORG_TOOLS_PAGE_CLASS(klass) (GTK_CHECK_CLASS_CAST ((klass), AUTHORG_TYPE_TOOLS_PAGE, AuthorgToolsPageClass))
#define AUTHORG_IS_TOOLS_PAGE(obj) (GTK_CHECK_TYPE ((obj), AUTHORG_TYPE_TOOLS_PAGE))
#define AUTHORG_IS_TOOLS_PAGE_CLASS(klass) (GTK_CHECK_CLASS_TYPE ((obj), AUTHORG_TYPE_TOOLS_PAGE))
...
GtkType authorg_tools_page_get_type (void);
